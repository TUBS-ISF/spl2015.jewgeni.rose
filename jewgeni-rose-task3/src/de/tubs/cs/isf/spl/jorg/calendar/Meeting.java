...
public class Meeting implements Comparable<Meeting> {
	...
	public String toString() {
		...
		return String.format("" + "Title:       %1$s%n" + "Description: %2$s%n" + "Date:        %3$te. %3$tB %3$tY%n"
						+ "Start:       %3$tR%n" + "End:         %4$tR%n" + "Place:       %5$s%n" + "%6$s", title,
						note, date, date.plus(duration), place, remind);
	}
}
