...
class MuteReminder extends Reminder {
	 ...
	 *            LDT of Meeting
	 * @param before
	 *            Duration to play before meeting begin
	 */
	...
	protected void play() {
		JOptionPane.showMessageDialog(null,
						"Your meeting '" + meeting.title() + "' is about to begin in " + before.toHours() + " hours",
	...
	public void run() {
		...
		while (!shutdown) {
			...
			try {
				Thread.sleep(Duration.ofMinutes(1).toMillis()); // sleep for a
																// minute and
																// check again
