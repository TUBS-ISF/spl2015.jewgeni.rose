...
public  class  UserMenu  extends BasicFeature {
    ...
    public UserMenu(final UserMenu system, final List<Feature> features) {
        ...
        menuString.append(App.PROMPT_BOLD + "user menu:\n" + App.PROMPT_NORMAL);
        menuString.append(String.format("%10s - exits user menu\n", "[" + EXIT + "]"));
        menuString.append(String.format("%10s - add a new user\n", "[" + ADD_USER + "]"));
        menuString.append(String.format("%10s - remove a user\n", "[" + REMOVE_USER + "]"));
        menuString.append(String.format("%10s - logout current user\n", "[" + LOGOUT_USER + "]"));
        menuString.append(String.format("%10s - login another registered user\n", "[" + LOGIN_USER + "]"));
        menuString.append(String.format("%10s - list all users\n", "[" + LIST_USERS + "]"));        
    }
